function onChange(control, oldValue, newValue, isLoading) {
    ...
    ga.getXMLAnswer(function(response) {
        ...
        //alert('description==> '+descriptionHelpTxt);
        //console.log('description==> '+descriptionHelpTxt);
       
        form.setValue('select_type_of_service_needed_help_text', descriptionHelpTxt); //for native UI
        form.setLabelOf('select_type_of_service_needed_options', instructionHelpTxt); //for portal
    });
}
